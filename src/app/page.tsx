    ...
    <div>
      <div style={{ width: "100%", height: "100%", position: "relative", background: "white" }}>
        ...
        <div style={{ width: 541, height: 166, left: 802, top: 384, position: "absolute" }}>
          ...
          <div style={{ width: 492, height: 30, left: 25, top: 37, position: "relative", background: "white" }} />
        </div>
        ...
        <Image style={{ width: 682, height: 815, left: 0, top: -0.55, position: "absolute" }} src={bg} alt="Background" />
      </div>
    </div>
  );
}
