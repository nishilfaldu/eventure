...
const Check: React.FC = () => {
  ...
  return (
    <>
      <Button type="primary" onClick={showModal} style={{ background: "#314995" }}>
        Edit Checklist
      </Button>
      <Modal title="Select all you need for your perfect event!" open={isModalOpen} onOk={handleOk}
        onCancel={handleCancel} okText="Save" okButtonProps={{ style: { backgroundColor: "#314995" } }}>
