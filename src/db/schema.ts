...
export const events = mysqlTable("events", {
  ...
  name: varchar("userId", { length: 256 }).notNull(),
  userId: varchar("userId", { length: 256 }).notNull(),
  decorationId: int("decorationId"),
  entertainmentId: int("entertainmentId"),
  foodId: int("foodId"),
  essentialId: int("essentialId"),
  favorId: int("favorId"),
  cleanupId: int("cleanupId"),
}, events => ({
